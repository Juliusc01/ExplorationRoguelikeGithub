...
class GameData 
{
	...
	public static var enemiesRandom:Array<Int> = [0, 1, 2, 3];
	public static var myLogger:CapstoneLogger;
	public static var testingHome:Bool = false;
	public static var roomToTest = AssetPaths.roomf_ESWN_test2__oel;
	...
	public static var level3 = new LevelData(3, 90, 4, 4, 0, 0, 1); 
	public static var level4 = new LevelData(4, 90, 5, 5, 1, 0, 1); // first food
	public static var level5 = new LevelData(5, 90, 7, 7, 2, 0, 1); 
	public static var level6 = new LevelData(6, 90, 7, 8, 3, 0, 2); // first gold
	public static var level7 = new LevelData(7, 120, 9, 10, 3, 0, 2);
	public static var level8 = new LevelData(8, 120, 8, 8, 3, 2, 2); // first stone
	public static var level9 = new LevelData(9, 150, 10, 9, 4, 3, 2);
	public static var level10 = new LevelData(10, 150, 12, 10, 5, 5, 3);
	public static var level11 = new LevelData(11, 150, 14, 11, 6, 5, 3);
	public static var level12 = new LevelData(12, 180, 16, 13, 6, 6, 3);
