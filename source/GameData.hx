...
class GameData 
{
	...
	public static var level3 = new LevelData(3, 90, 5, 5, 1, 0, 1.0); // first food
	public static var level4 = new LevelData(4, 90, 7, 7, 2, 0, 1.0); 
	public static var level5 = new LevelData(5, 90, 7, 8, 3, 0, 1.2); // first gold
	public static var level6 = new LevelData(6, 120, 8, 8, 3, 2, 1.4); // first stone
